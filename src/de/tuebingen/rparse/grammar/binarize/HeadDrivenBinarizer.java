...
/**
 * Binarize head-outward. Head must be marked before.
 * 
 * @author wmaier
 */
public class HeadDrivenBinarizer extends MarkovizingBinarizer {

    public HeadDrivenBinarizer(String params, int v, int h, boolean noArities)
